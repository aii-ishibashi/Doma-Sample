...
public class UsersDaoTest {
    ...
    protected void setUp() throws Exception {
        ...
        url = "jdbc:h2:mem:develop;MODE=Mysql;DB_CLOSE_ON_EXIT=TRUE";
        user = "sa";
        password = "";
    }
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/ai/inside/domademo2/dao/UsersDao/selectById.sql", dialect);
        execute(sqlFile);
    }
    ...
    public void testSelectAll(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/ai/inside/domademo2/dao/UsersDao/selectAll.sql", dialect);
        execute(sqlFile);
    }
